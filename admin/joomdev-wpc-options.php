    	...
    	<div class="wrap">
            ...
            <div class="joomdev-wpc-settings-header">
                <div class="column-left">
                    <div class="clear"></div>
                    <h1><img src="<?php echo plugins_url( JOOMDEV_DIR . '/images/joomdev-wpc.png' ); ?>"> <span><b>WP Pros &amp; Cons</b> <small><small>by <b><i>JoomDev</i></b></small></small></span></h1>
                    <div class="clear"></div>
                </div>
                <div class="column-right">
                    <a href="<?php echo JOOMDEV_MORE_THEMES_PLUGINS_URL; ?>" target="_BLANK" class="joomdev-more-themes-plugins-button"><img src="<?php echo plugins_url(JOOMDEV_DIR . '/images/font-awesome_4-7-0_shopping-cart_256_0_ffffff_none.png'); ?>"> More WP Themes &amp; Plugins</a>
                </div>
                <div class="clear"></div>
            </div>
...
function joomdev_wpc_enqueue_editor_scripts($plugin_array){
    ...
    $plugin_array["joomdev_wpc_shortcode"] =  plugins_url( JOOMDEV_DIR . '/js/editor.js?ver=' . JOOMDEV_VER );
    return $plugin_array;
}
    ...
    ?>
        ...
        <div id="joomdev_wpc_editor_button_popup" class="hidden" style="max-width:800px">
            <div class="joomdev-wpc-settings-header">
                <div class="column-left">
                    <div class="clear"></div>
                    <h3><img src="<?php echo plugins_url( JOOMDEV_DIR . '/images/joomdev-wpc.png' ); ?>"> <span><b>WP Pros &amp; Cons</b> <small><small>by <b><i>JoomDev</i></b></small></small></span></h3>
                    <div class="clear"></div>
                </div>
                <div class="column-right">
                    <a href="<?php echo JOOMDEV_MORE_THEMES_PLUGINS_URL; ?>" target="_BLANK" class="joomdev-more-themes-plugins-button"><img src="<?php echo plugins_url(JOOMDEV_DIR . '/images/font-awesome_4-7-0_shopping-cart_256_0_ffffff_none.png'); ?>"> More WP Themes &amp; Plugins</a>
